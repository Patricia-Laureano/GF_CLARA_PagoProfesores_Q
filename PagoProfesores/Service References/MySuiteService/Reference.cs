...
namespace PagoProfesores.MySuiteService {
    using System.Data;
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.fact.com.mx/schema/ws", ConfigurationName="MySuiteService.FactWSFrontSoap")]
    public interface FactWSFrontSoap {
        ...
        PagoProfesores.MySuiteService.TransactionTag RequestTransaction(string Requestor, string Transaction, string Country, string Entity, string User, string UserName, string Data1, string Data2, string Data3);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.fact.com.mx/schema/ws/RequestTransaction", ReplyAction="*")]
        System.Threading.Tasks.Task<PagoProfesores.MySuiteService.TransactionTag> RequestTransactionAsync(string Requestor, string Transaction, string Country, string Entity, string User, string UserName, string Data1, string Data2, string Data3);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        PagoProfesores.MySuiteService.ServiceCallResult ServiceCall(string rfc, string user, string tran, string pars, string additionalPars, string LastTimeStamp);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.fact.com.mx/schema/ws/ServiceCall", ReplyAction="*")]
        System.Threading.Tasks.Task<PagoProfesores.MySuiteService.ServiceCallResult> ServiceCallAsync(string rfc, string user, string tran, string pars, string additionalPars, string LastTimeStamp);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface FactWSFrontSoapChannel : PagoProfesores.MySuiteService.FactWSFrontSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class FactWSFrontSoapClient : System.ServiceModel.ClientBase<PagoProfesores.MySuiteService.FactWSFrontSoap>, PagoProfesores.MySuiteService.FactWSFrontSoap {
        ...
        public PagoProfesores.MySuiteService.TransactionTag RequestTransaction(string Requestor, string Transaction, string Country, string Entity, string User, string UserName, string Data1, string Data2, string Data3) {
            return base.Channel.RequestTransaction(Requestor, Transaction, Country, Entity, User, UserName, Data1, Data2, Data3);
        }
        
        public System.Threading.Tasks.Task<PagoProfesores.MySuiteService.TransactionTag> RequestTransactionAsync(string Requestor, string Transaction, string Country, string Entity, string User, string UserName, string Data1, string Data2, string Data3) {
        ...
        public PagoProfesores.MySuiteService.ServiceCallResult ServiceCall(string rfc, string user, string tran, string pars, string additionalPars, string LastTimeStamp) {
            return base.Channel.ServiceCall(rfc, user, tran, pars, additionalPars, LastTimeStamp);
        }
        
        public System.Threading.Tasks.Task<PagoProfesores.MySuiteService.ServiceCallResult> ServiceCallAsync(string rfc, string user, string tran, string pars, string additionalPars, string LastTimeStamp) {
