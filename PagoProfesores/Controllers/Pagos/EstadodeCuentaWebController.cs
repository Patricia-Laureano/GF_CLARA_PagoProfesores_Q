    ...
    public class EstadodeCuentaWebController : Controller
    {
        ...
        public void setDatosProfesor(SessionDB session, EstadodeCuentaWebModel model)
        {
            ...
            if (sesion.vdata["HmeAclzn"] == "No")
                ...
                //if (updateSede == true)
                if (Request.Params["filter_Sede"] != null)
                {
                ...
                else
                {
                    ...
                    {
                        sesion.vdata["Sede"] = model.GetSedes(sesion.vdata["ID_PERSONA"]);
                    }
                }

            //-----validación ajuste bug
            string sql2 = "SELECT ps.CVE_SEDE,ps.ID_PERSONA  ,p.NACIONALIDAD,p.TELEFONO,p.CORREO365 FROM PERSONAS_SEDES ps INNER JOIN PERSONAS p ON ps.ID_PERSONA=p.ID_PERSONA WHERE P.IDSIU='" + sesion.vdata["IDSIU"] + "' AND  ps.CVE_SEDE='" + sesion.vdata["Sede"] + "'";
            ...
            try
            {
                if (res2.Next())
                {
                    sesion.vdata["ID_PERSONA"] = res2.Get("ID_PERSONA");
                    model.Sede = res2.Get("CVE_SEDE");
                ...
                model.telefonoPersonal = res2.Get("TELEFONO");
                model.nacionalidad = res2.Get("NACIONALIDAD");
                model.CorreoO365 = res2.Get("CORREO365");
            }
            catch (Exception ex)
            {
                sesion.vdata["Sede"] = model.GetSede(sesion.vdata["IDSIU"]);
        ...
        public ActionResult Start()
        {
            try
            {
                ...
                sesion.vdata["ID_PERSONA"] = model.GetIdPersona(sesion.vdata["IDSIU"], sesion.vdata["Sede"]).ToString();
                if (sesion.vdata["ID_PERSONA"] == "0")
                {
                    sesion.vdata["ID_PERSONA"] = model.GetIDpersona(IDSIU);
                }
                ...
                Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Estado de Cuenta Web", sesion);
        ...
        public ActionResult PagosPendientes(EstadodeCuentaWebModel model)
        {
            ...
            try
            {
                ...
                // SEDES DATOS SOPRTE
                model.GetDatosSoporte();

                ViewBag.Email_Sociedad = model.Email_Sociedad;
                ViewBag.Telefono_Soporte = model.Telefono_Soporte;
                ViewBag.Campus = model.Campus;
                ViewBag.Entidad = model.Entidad_Estado_Pais_Sede;
                ViewBag.Nombre_Responsable = model.Nombre_Responsable;
                ...
                Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Pagos Pendientes", sesion);
            }
            catch (Exception e)
            {
        ...
        public ActionResult PagosDepositados()
        {
            ...
            try
            {
                ...
                Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Pagos Depositados", sesion);
        ...
        public ActionResult Contratos()
        {
            ...
            try
            {
                ...
                sesion.saveSession();
                ViewBag.Table_Contratos = "";
                ViewBag.Table_Contratos = model.GetContratos(Request);

                Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Contratos", sesion);
                //Log.write(this, "Start", LOG.CONSULTA, "Ingresa Pantalla Estado de cuenta Web", sesion);
            }
            catch (Exception e)
            {
        ...
        public ActionResult ConstanciasRetencion()
        {
            ...
            try
            {
                ...
                Scripts.SCRIPTS = new string[]
             {
                ...
                Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Constancia de Retención", sesion);
        ...
        public ActionResult ConstanciasRetencionAnualPeriodo()
        {
            ...
            try
            {
                ...
                Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Constancia de Retención Anual por Periodo", sesion);
                //Log.write(this, "Start", LOG.CONSULTA, "Ingresa Pantalla Estado de cuenta Web", sesion);
            }
            catch (Exception e)
            {
        ...
        public ActionResult ConstanciasRetencionAnual()
        {
            ...
            try
            {
                ...
                Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Cosntancia de Retención Anual", sesion);
                //Log.write(this, "Start", LOG.CONSULTA, "Ingresa Pantalla Estado de cuenta Web", sesion);
            }
            catch (Exception e)
            {
        ...
        public ActionResult Home()
        {
            ...
            try
            {
                ...
                ViewBag.DireccionFiscal = model.DireccionFis_Domicilio;
                // Datos fiscales
                model.GetDatosFiscales();
                ...
                if (!string.IsNullOrWhiteSpace(model.NoCuenta) || !string.IsNullOrWhiteSpace(model.CuentaClabe))
                {
        ...
        public ActionResult Perfil()
        {
            ...
            try
            {
                ...
                ViewBag.DireccionFiscal = model.DireccionFis_Domicilio;
                ViewBag.nacionalidad = model.nacionalidad;
                ViewBag.telefono = model.telefonoPersonal;
                ViewBag.correo = model.CorreoO365;
                // Datos fiscales
                model.GetDatosFiscales();
                ...
                Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Perfil", sesion);
                //Log.write(this, "Start", LOG.CONSULTA, "Ingresa Pantalla Estado de cuenta Web", sesion);
            }
            catch (Exception e)
            {
        ...
        public ActionResult DetallePago()
        {
            ...
            try
            {
                ...
                Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Detalle de Pago", sesion);
        ...
        public ActionResult DetallePagoDepositado()
        {
            ...
            try
            {
                ...
                Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Detalle de Pago Depositado", sesion);
                //Log.write(this, "Start", LOG.CONSULTA, "Ingresa Pantalla Estado de cuenta Web", sesion);
            }
            catch (Exception e)
            {
        ...
        public ActionResult Tutoriales()
        {
            ...
            Log.write(this, "Estado de Cuenta Web", LOG.CONSULTA, "Ingresa Pantalla Tutoriales", sesion);
