...
TabuladorList.setTabuladorList_success = function () {
}
...
function handlerdataAtributos() {
    if ((gup('Atributos') != "")) { $('#Atributos').val(gup('Atributos')); }
}
...
var DataTable = function () {
	...
	"use strict"; return {
		...
		exportExcel: function (table) {
		    window.location.href = '/PA/ExportExcel';
		},
