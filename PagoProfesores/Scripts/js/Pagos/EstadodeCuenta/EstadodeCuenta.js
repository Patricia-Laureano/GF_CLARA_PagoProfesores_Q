    ...
    "use strict"; return {
        ...
        eliminar: function () {
            ...
            if (arrChecked.length == 0) {
             ...
             if ($('#motivo').val() == null || $('#motivo').val() == '') {
                alert('Debes ingresar el motivo de eliminación');
                return;
            }
        ...
        setLinksXMLyPDF: function (data) {
            ...
            if (data.file_xml_name == '') {
                ...
                $('#file_xml_name').hide();
                if ($("#m_tipoDePagoEC").val() == "ADI") {
                    $('#file_xml_link').html('<a ' + data.file_xml_name + '><i class="fa fa-download"></i>&nbsp;Mostrar archivo XML</a>');
                } else {
            ...
            if (data.file_pdf_name == '') {
                ...
                $('#file_pdf_name').hide();
                if ($("#m_tipoDePagoEC").val() == "ADI") {
                    $('#file_pdf_link').html('<a ' + data.file_pdf_name + '><i class="fa fa-download"></i>&nbsp;Mostrar archivo PDF</a>');
                } else {
