...
var formPage = function () {
    ...
    "use strict"; return {
        ...
        clean: function () {
            ...
            $("#fi_direccion_cp").val("");
            $("#fi_direccion_pais").val("");
            $("#fi_direccion_estado").val("");
            $("#fi_direccion_ciudad").val("");
            $("#fi_direccion_entidad").val("");
            $("#fi_direccion_colonia").val("");
            $("#fi_direccion_calle").val("");
            $("#fi_direccion_numero").val("");
            ...
            $("#fi_direccion_cp").html("");
            $("#fi_direccion_pais").html("");
            $("#fi_direccion_estado").html("");
            $("#fi_direccion_ciudad").html("");
            $("#fi_direccion_entidad").html("");
            $("#fi_direccion_colonia").html("");
            $("#fi_direccion_calle").html("");
            $("#fi_direccion_numero").html("");
            ...
            $("#notarial_no").val("");
            $("#notarial_volumen").val("");
            $("#notaria_lugar").val("");
            $("#notarial_notario_no").val("");
            $("#notarial_lic").val("");
        ...
        edit: function (id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#fi_direccion_pais").html("<option>" + data.Fi_Direccion_Pais + "</option>");
                    $("#fi_direccion_estado").html("<option>" + data.Fi_Direccion_Estado + "</option>");
                    $("#fi_direccion_ciudad").html("<option>" + data.Fi_Direccion_Ciudad + "</option>");
                    $("#fi_direccion_entidad").html("<option>" + data.Fi_Direccion_Entidad + "</option>");
                    $("#fi_direccion_colonia").html("<option>" + data.Fi_Direccion_Colonia + "</option>");
                    $("#fi_direccion_calle").val(data.Fi_Direccion_Calle);
                    $("#fi_direccion_numero").val(data.Fi_Direccion_Numero);
                    $("#fi_direccion_cp").val(data.Fi_Direccion_Cp);
                    ...
                    $("#notarial_no").val(data.notarial_no);
                    $("#notarial_volumen").val(data.notarial_volumen);
                    $("#notaria_lugar").val(data.notaria_lugar);
                    $("#notarial_notario_no").val(data.notarial_notario_no);
                    $("#notarial_lic").val(data.notarial_lic);
                    ...
                    $("#rz_repLeg").val(data.Rz_Represnetante_Legal_P)
                },
            });
        },
        ...
        createModel: function (Idsiu) {
            return {
                ...
                Rz_Curp: $("#rz_curp").val(),
                Rz_Represnetante_Legal_P: $("#rz_repLeg").val(),
                ...
                cveSede: $('#Sedes').val(),
                notarial_no: $("#notarial_no").val(),
                notarial_volumen: $("#notarial_volumen").val(),
                notaria_lugar: $("#notaria_lugar").val(),
                notarial_notario_no: $('#notarial_notario_no').val(),
                notarial_lic: $('#notarial_lic').val(),
                Fi_Direccion_Pais: $("#fi_direccion_pais").val(),
                Fi_Direccion_Estado: $("#fi_direccion_estado").val(),
                Fi_Direccion_Ciudad: $("#fi_direccion_ciudad").val(),
                Fi_Direccion_Entidad: $("#fi_direccion_entidad").val(),
                Fi_Direccion_Colonia: $("#fi_direccion_colonia").val(),
                Fi_Direccion_Calle: $("#dfi_ireccion_calle").val(),
                Fi_Direccion_Numero: $("#fi_direccion_numero").val(),
                Fi_Direccion_Cp: $("#fi_direccion_cp").val(),
            }
        },
