...
var formPage = function () {
	...
	"use strict"; return {
		...
		subirExcel: function () {
			...
			startTimer("ImportarDatosExcel", function () {
				$.ajax({
					type: 'POST',
					cache: false,
					url: '/ImportarDatosExcel/FindFirstError',
		...
		importar: function () {
			...
			loading('loading-circle', '#seccion1', 'Importando Docentes desde EXCEL..');

			$.ajax({
				type: "POST",
				cache: false,
				url: "/ImportarDatosExcel/importar",
				data: {},
	...
	"use strict"; return {
		...
		init: function () {
			...
			$.ajax({
				type: "GET",
				cache: false,
				url: "/ImportarDatosExcel/CreateDataTable/",
